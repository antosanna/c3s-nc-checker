...
# installation and source code. (MIT License)
...
_unit_database =os.path.abspath(  os.path.join(os.path.dirname(__file__),
                              'resources/udunits/udunits2.xml') )
...
# A length ut_unit (equivalent to 'm', 'cm', etc.) CeB
_length_ut_unit = _ut_parse(_ut_system, _c_char_p('meter'), _UT_ASCII)
_cached_ut_unit['meter'] = _length_ut_unit
...
'''
    ...
    # ----------------------------------------------------------------
    # Attribute (read only) CeB Adding
    # ----------------------------------------------------------------
    @property
    def islength(self):
        ...
        return bool(_ut_are_convertible(ut_unit, _length_ut_unit))
    #--- End: def
